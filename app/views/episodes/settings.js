        ...
        <div class="stack">
          ...
          ${ episode.documents.map( document => html`
            <div class="layout-row gap">
              ...
              <input class="is-wide-2" value="${document.name}" placeholder="Document Name"/>
              <input value="${document.googleDocId}" placeholder="Google Doc ID"/>
              <input class="is-wide-2" value="${document.icon}" placeholder="Icon"/>
              <div class="is-wide-4">
          ...
          <form>
            <div class="layout-row gap">
              ...
              <input class="is-wide-2"  placeholder="Document Name"/>
              <input placeholder="Google Doc ID"/>
              <input class="is-wide-2"  placeholder="Icon"/>
              <div class="is-wide-4">
